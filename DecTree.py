...
print("==============================GINI==================")
dec_model = tree.DecisionTreeClassifier(criterion='gini', class_weight="balanced", min_weight_fraction_leaf=0.01)
...
print("==============================ENTOPRY==================")
dec_model = tree.DecisionTreeClassifier(criterion='entropy', class_weight="balanced", min_weight_fraction_leaf=0.01)
